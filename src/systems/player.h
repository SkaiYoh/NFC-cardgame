...
// Initialize a player with their viewport area and side on the Battlefield.
// Camera targets the center of the player's territory in canonical coords.
// Card slot spawn positions are read from Battlefield.
